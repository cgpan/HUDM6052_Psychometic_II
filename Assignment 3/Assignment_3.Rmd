...
itemfit(mod_3pl)
```  
Only `item 3` and `item 27` are statistically flagged under the family-wise Type I error rate of .05, with the Bonferroni correction being poorly fitted items. [*I found this type of interpretation from a textbook. To my current knowledge, I am not very clear about this test. I will dive in later.*]
