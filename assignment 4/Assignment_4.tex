...
The plot shows that the corresponding trait level is around 2.255. Next,
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{1.052787}
\end{Highlighting}
\end{Shaded}

Based on the all the calculation above, for a student with true score of
8, his/ her corresponding trait level for this short test is 2.255 with
