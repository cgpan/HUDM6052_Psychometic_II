...
\SpecialCharTok{\textgreater{}}\NormalTok{ tscore }\OtherTok{\textless{}{-}} \FunctionTok{expected.test}\NormalTok{(irt\_2pl, theta)}
\SpecialCharTok{\textgreater{}}\NormalTok{ t\_t }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
\SpecialCharTok{+}   \AttributeTok{theta=}\NormalTok{ theta,}
\SpecialCharTok{+}   \AttributeTok{tscore =}\NormalTok{ tscore}
\SpecialCharTok{+}\NormalTok{ )}
\SpecialCharTok{\textgreater{}}\NormalTok{ t\_t }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(t\_t,}\DecValTok{3}\NormalTok{)}
\SpecialCharTok{\textgreater{}}\NormalTok{ theta\_20 }\OtherTok{\textless{}{-}}\NormalTok{ t\_t[t\_t}\SpecialCharTok{$}\NormalTok{tscore }\SpecialCharTok{==} \DecValTok{20}\NormalTok{,]}\SpecialCharTok{$}\NormalTok{F1}
\SpecialCharTok{\textgreater{}}\NormalTok{ t\_t[t\_t}\SpecialCharTok{$}\NormalTok{tscore }\SpecialCharTok{==} \DecValTok{20}\NormalTok{,]}
\NormalTok{       F1 tscore}
\DecValTok{851} \FloatTok{0.413}     \DecValTok{20}
\end{Highlighting}
\end{Shaded}

The results show that the trait level of true score 20 is 0.413.
Therefore, we need to select 10 items to have the maximum information on
the 0.413.

Next, I try to get the information values of each item on 0.413 and sort
...
\SpecialCharTok{+}\NormalTok{   info\_tempt }\OtherTok{\textless{}{-}} \FunctionTok{iteminfo}\NormalTok{(}\FunctionTok{extract.item}\NormalTok{(irt\_1pl, i), theta\_20)}
...
\DecValTok{11}\NormalTok{ mathc12  }\FloatTok{0.2304691}
\DecValTok{24}\NormalTok{ mathc26  }\FloatTok{0.2302910}
\DecValTok{14}\NormalTok{ mathc15  }\FloatTok{0.2302576}
\DecValTok{18}\NormalTok{ mathc19  }\FloatTok{0.2298369}
\DecValTok{13}\NormalTok{ mathc14  }\FloatTok{0.2296082}
\DecValTok{30}\NormalTok{ mathc33  }\FloatTok{0.2276869}
\DecValTok{31}\NormalTok{ mathc34  }\FloatTok{0.2274038}
\DecValTok{32}\NormalTok{ mathc35  }\FloatTok{0.2272373}
\DecValTok{27}\NormalTok{ mathc29  }\FloatTok{0.2261145}
\DecValTok{16}\NormalTok{ mathc17  }\FloatTok{0.2258490}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{1}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6666.931}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.24246}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{2}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6639.237}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.14015}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{3}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6632.172}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.08349}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{4}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6630.201}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.04936}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{5}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.661}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.02940}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{6}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.505}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.01778}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{7}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.445}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.00846}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{8}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.436}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.00487}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{9}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.434}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.00331}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{10}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.432}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.00064}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{11}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.432}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.00047}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{12}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.432}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.00036}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{13}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.432}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.00029}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{14}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.432}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.00022}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{15}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.432}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.00016}\NormalTok{Iteration}\SpecialCharTok{:} \DecValTok{16}\NormalTok{, Log}\SpecialCharTok{{-}}\NormalTok{Lik}\SpecialCharTok{:} \SpecialCharTok{{-}}\FloatTok{6629.432}\NormalTok{, Max}\SpecialCharTok{{-}}\NormalTok{Change}\SpecialCharTok{:} \FloatTok{0.00007}
...
\NormalTok{Full}\SpecialCharTok{{-}}\NormalTok{information item factor analysis with }\DecValTok{1} \FunctionTok{factor}\NormalTok{(s).}
\NormalTok{Converged within }\FloatTok{1e{-}04}\NormalTok{ tolerance after }\DecValTok{16}\NormalTok{ EM iterations.}
\NormalTok{mirt version}\SpecialCharTok{:} \FloatTok{1.40} 
\NormalTok{M}\SpecialCharTok{{-}}\NormalTok{step optimizer}\SpecialCharTok{:}\NormalTok{ BFGS }
\NormalTok{EM acceleration}\SpecialCharTok{:}\NormalTok{ Ramsay }
\NormalTok{Number of rectangular quadrature}\SpecialCharTok{:} \DecValTok{61}
...
\NormalTok{Information matrix estimated with method}\SpecialCharTok{:}\NormalTok{ Oakes}
\NormalTok{Second}\SpecialCharTok{{-}}\NormalTok{order test}\SpecialCharTok{:}\NormalTok{ model is a possible local maximum}
\NormalTok{Condition number of information matrix }\OtherTok{=}  \FloatTok{7.242151}

\NormalTok{Log}\SpecialCharTok{{-}}\NormalTok{likelihood }\OtherTok{=} \SpecialCharTok{{-}}\FloatTok{6629.432}
\NormalTok{Estimated parameters}\SpecialCharTok{:} \DecValTok{20} 
\NormalTok{AIC }\OtherTok{=} \FloatTok{13298.86}
\NormalTok{BIC }\OtherTok{=} \FloatTok{13397.82}\NormalTok{; SABIC }\OtherTok{=} \FloatTok{13334.3}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\SpecialCharTok{\textgreater{}} \CommentTok{\# get the estimated person trait}
\ErrorTok{\textgreater{}}\NormalTok{ mirt\_trait\_out }\OtherTok{\textless{}{-}} \FunctionTok{fscores}\NormalTok{(irt\_2pl\_short, }\AttributeTok{method =} \StringTok{\textquotesingle{}EAP\textquotesingle{}}\NormalTok{, }\AttributeTok{full.scores =}\NormalTok{ F, }\AttributeTok{full.scores.SE =}\NormalTok{ T)}
...
\SpecialCharTok{\textgreater{}}\NormalTok{ mirt\_trait }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(mirt\_trait[}\FunctionTok{which}\NormalTok{(}\FunctionTok{complete.cases}\NormalTok{(mirt\_trait)),}\FunctionTok{c}\NormalTok{(}\DecValTok{11}\SpecialCharTok{:}\DecValTok{12}\NormalTok{)],}\DecValTok{3}\NormalTok{)}
\SpecialCharTok{\textgreater{}} \FunctionTok{library}\NormalTok{(latticeExtra)}
\SpecialCharTok{\textgreater{}}\NormalTok{ key }\OtherTok{=} \FunctionTok{list}\NormalTok{(}\AttributeTok{colums=}\DecValTok{1}\NormalTok{,}
\SpecialCharTok{+}            \AttributeTok{text=}\FunctionTok{list}\NormalTok{(}\AttributeTok{lab =} \FunctionTok{c}\NormalTok{(}\StringTok{"TCC\_overall"}\NormalTok{,}\StringTok{"TCC\_10"}\NormalTok{)),}
